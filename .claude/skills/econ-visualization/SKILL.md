...
"""
============================================================
Publication-Quality Figure in Python
============================================================
"""
...
# Set style (see .claude/rules/python-code-conventions.md for PALETTE)
...
for country in df["country"].unique():
    ...
    ax.plot(data["year"], data["gdp_per_capita"], label=country, linewidth=1.5)
...
output_path = Path("figures/gdp_per_capita.png")
fig.savefig(
    output_path,
    dpi=300,
    bbox_inches="tight",
