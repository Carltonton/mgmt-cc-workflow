...
- We have institutional context (specific tools, conventions)

### Identity 2: Public Template
- Others fork this repo to bootstrap their own academic workflows
- They use different domains (biology, physics, CS, not just organizational psychology)
...
- Institutional requirements (thesis format, submission guidelines)
...
Always use XeLaTeX with TEXINPATHS=../Preambles for your project's slides.
```
...
- Management: CFA/SEM scale validation
```
...
> "This workflow was developed for academic research at [YOUR INSTITUTION]..."
...
> "Case Study: PhD thesis, 3-part structure, Grounded theory + CFA/SEM + Causal inference"
